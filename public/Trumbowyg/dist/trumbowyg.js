    ...
    Trumbowyg.prototype = {
        ...
        openModalInsert: function (title, fields, cmd) {
            ...
            $.each(fields, function (fieldName, field) {
                ...
                var lable = field.type == "hidden" ? '' : '<span class="' + prefix + 'input-infos"><span>' + ((!l) ? (lg[fieldName] ? lg[fieldName] : fieldName) : (lg[l] ? lg[l] : l)) + '</span></span>';
                html += '<label><input type="' + (field.type || 'text') + '" name="' + n + '" value="' + (field.value || '').replace(/"/g, '&quot;') + '"' + attr + '>' + lable + '</label>';
            });
