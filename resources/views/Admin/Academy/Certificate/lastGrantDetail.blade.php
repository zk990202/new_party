...
<script>
    $(function(){
        ...
        $.ajax({
            url : '/admin/academy/certificate/last-grant/'+$('#lostId').val(),
            type: 'GET',
            dataType: 'json',
...
//                        alert(content);
        ...
        $('#submitButtonPass').click(function () {
            if(confirm('是否确认通过补办？')){
                ...
                $.ajax({
                    url: '/admin/academy/certificate/last-grant/' + $('#lostId').val() + '/detail',
                    type: 'POST',
                    data: form,
                    cache: false,
                    dataType: 'json',
                    ...
                    success: function(data){
                        if(data.success){
                            alert('补办成功');
                            window.location.href = '/admin/academy/certificate/last-grant';
                        }
                        else{
                            alert(data.message);
                        }
        ...
        $('#submitButtonReject').click(function () {
            if(confirm('是否确认驳回补办？')){
                ...
                form.append('dealWord', $('#editor').val());
                $.ajax({
                    url: '/admin/academy/certificate/last-grant/' + $('#lostId').val() + '/reject',
                    type: 'POST',
                    data: form,
                    cache: false,
                    dataType: 'json',
