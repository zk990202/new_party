                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($tests as $test)
                            <tr>
                                <td>
                                    <a href="{{ url('admin/academy/test-list/'.$test['id'].'/detail') }}">{{ $test['name'] }}</a>
                                </td>
                                ...
                                <td>
                                    <a href="{{ url('admin/academy/test-list/'.$test['id']).'/edit' }}">
...
<script>
    ...
    var deleteTest = function(id) {
        $.ajax({
            url: '/admin/academy/test-list/' + id + '/delete',
            method: 'patch',
            dataType : 'json',
    ...
    var startSign = function (id) {
        $.ajax({
            url: '/admin/academy/test-list/' + id + '/change/1',
            method: 'patch',
            dataType: 'json',
            success: function (data) {
                if(data.success){
    ...
    var endSign = function (id) {
        $.ajax({
            url: '/admin/academy/test-list/' + id + '/change/2',
            method: 'patch',
            dataType: 'json',
            success: function (data) {
                if(data.success){
    ...
    var gradeInput = function (id) {
        $.ajax({
            url: '/admin/academy/test-list/' + id + '/change/3',
            method: 'patch',
            dataType: 'json',
            success: function (data) {
                if(data.success){
    ...
    var endInput = function (id) {
        $.ajax({
            url: '/admin/academy/test-list/' + id + '/change/4',
            method: 'patch',
            dataType: 'json',
            success: function (data) {
                if(data.success){
    ...
    var endTest = function (id) {
        $.ajax({
            url: '/admin/academy/test-list/' + id + '/change/5',
            method: 'patch',
            dataType: 'json',
            success: function (data) {
                if(data.success){
