    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    <div>
                        <a href="{{ url('admin/applicant/exam/add') }}">
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($exams as $exam)
                            <tr>
                                <td>
                                    <a href="{{ url('admin/applicant/exam/'.$exam['id'].'/detail') }}">
                                        {{ $exam['name'] }}
                                    </a>
                                </td>
                                <td>{{ $exam['time'] }}</td>
                                ...
                                <td>
                                    <a href="{{ url('admin/applicant/exam/'.$exam['id'].'/edit') }}">
...
<script>
    ...
    var deleteExam = function deleteExam (examId) {
        $.ajax({
            'url': '/admin/applicant/exam/' + examId + '/delete',
            'method': 'post',
    ...
    var startSign = function (id) {
        $.ajax({
            url: '/admin/applicant/exam/' + id + '/change/1',
            method: 'patch',
            dataType: 'json',
            success: function (data) {
                if(data.success){
    ...
    var endSign = function (id) {
        $.ajax({
            url: '/admin/applicant/exam/' + id + '/change/2',
            method: 'patch',
            dataType: 'json',
            success: function (data) {
                if(data.success){
    ...
    var gradeInput = function (id) {
        $.ajax({
            url: '/admin/applicant/exam/' + id + '/change/3',
            method: 'patch',
            dataType: 'json',
            success: function (data) {
                if(data.success){
    ...
    var endInput = function (id) {
        $.ajax({
            url: '/admin/applicant/exam/' + id + '/change/4',
            method: 'patch',
            dataType: 'json',
            success: function (data) {
                if(data.success){
    ...
    var endExam = function (id) {
        $.ajax({
            url: '/admin/applicant/exam/' + id + '/change/5',
            method: 'patch',
            dataType: 'json',
            success: function (data) {
                if(data.success){
