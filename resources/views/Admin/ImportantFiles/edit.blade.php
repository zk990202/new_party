                ...
                <form role="form" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-group" >
                            ...
                            <input type="text" class="form-control" id="filesTitle" value="{{ $files['title'] }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <p class="help-block">
                                @if($files['filePath'])
                                    已有文件：<a target="_blank" href="{{$files['filePath'].'/download/'.$files['title']}}">点击下载</a>，如不更改请勿重新添加<br/>
                                @endif
                                支持文件格式：
                    ...
                    <!-- /.box-body -->
                    <input type="hidden" id="filesId" value="{{ $files['id'] }}">
                </form>
...
<script>
    $(function(){
        ...
        $.ajax({
            url : '/admin/important-files/'+$('#filesId').val(),
            type: 'GET',
            dataType: 'json',
            ...
            if(file){
                ...
                $.ajax({
                    ...
                    if(data.success){
                        ...
                        $.ajax({
                            url: '/admin/important-files/' + $('#filesId').val() + '/edit',
                            type: 'POST',
                            data: form,
                            cache: false,
                            dataType: 'json',
                            ...
                            success: function(data){
                                if(data.success){
                                    alert('修改成功');
                                    window.location.href = '/admin/important-files/list';
                                }
                                else{
                                    alert(data.message);
                                }
