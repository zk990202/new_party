                ...
                <form role="form" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-group" >
                            ...
                            <input type="text" class="form-control" id="eBooksTitle" placeholder="电子书标题请尽量简明扼要，不要太长">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <p class="help-block">支持文件格式:
                                {{ \App\Http\Service\FileService::allowedFileExtension('theoryStudyEBook') }}  </p>
                        </div>
                    </div>
                    <!-- /.box-body -->
                </form>
            ...
            if(file){
                ...
                $.ajax({
                    ...
                    if(data.success){
                        ...
                        $.ajax({
                            url: '/admin/theory-study/add/eBook',
                            type: 'POST',
                            data: form,
                            cache: false,
                            dataType: 'json',
