...
<div class="total">
    <nav class="find">
        ...
        <div class="btn">
            <p class="nav1"><a href="ApplicantTraining.html">申请人培训</a></p>
            <p><a href="InstituteActivistTrain.html">院积极分子培训</a></p>
            <p><a href="ProbationaryPartyMember.html">预备党员培训</a></p>
            <p><a href="PartyBranchSecretary.html">党支部书记培训</a></p>
            <p><a href="ActiveNotice.html">活动通知</a></p>
        </div>
    </nav>
    <div class="info">
        <h2>申请人培训</h2>
        <hr/>
        <div>
            <h1>第五十四期入党申请人培训结业考试成绩查询通知</h1>
            <p>天津大学入党申请人党校结业考试 复习指导与专题训练,第五十四期入党申请人培训结业考试座位图发布,
                第五十四期入党申请人培训结业考试报名通知,第五十三期入党申请人培训结业考试成绩查询通知..</p>
        </div>
        <div>
            <h1>第五十四期入党申请人培训结业考试成绩查询通知</h1>
            <p>天津大学入党申请人党校结业考试 复习指导与专题训练,第五十四期入党申请人培训结业考试座位图发布,
