...
<div class="module">
    <div class="item1">
        <div class="state">
            <img src="/jquery/img3/user.png" class="item1-img"/>
            <p>个人状态</p>
            @if(!$userInfo)
                <span>登陆查看个人状态</span>
                <br/>
            ...
            @else
                用户：{{ $userInfo['real_name'] }}<br>
                状态：申请人
            @endif
        </div>
        <div class="notice">
            <img src="/jquery/img3/notice.png" class="item1-img"/>
            <p>最新通知</p>
            @foreach($notice as $notices)
                <li>
                    <a href="{{ url('/api/notice/'.$notices['id'].'/detail') }}">
                        <span class="news">{{ $notices['title'] }}</span>
                    </a>
                    <span class="date">{{ $notices['time'] }}</span>
                </li>
                <hr/>
            @endforeach
        </div>
    ...
    <div class="item1">
        <div class="special">
            <img src="/jquery/img3/notice.png" class="item1-img"/>
            <p>党建专项</p>
            <img class="item-pic" src="/jquery/img3/partybuild_special.jpg"/>
            <ul class="index">
                @foreach($partyBuild as $partyBuilds)
                    <li>
                    <a href="{{ url('/api/party-build/'.$partyBuilds['id'].'/detail') }}">
                        <span>{{ $partyBuilds['title'] }}</span>
                    </a>
                    </li>
                @endforeach
        ...
        <div class="special1">
            <img src="/jquery/img3/notice.png" class="item1-img"/>
            <p>支部风采</p>
            <img class="item-pic" src="/jquery/img3/branch_activity.jpg"/>
            <ul class="index">
                @foreach($branchActivity as $branchActivities)
                    <li>
                    <a href="{{ url('api/branch-activity/'.$branchActivities['id'].'/detail') }}">
                        <span>{{ $branchActivities['name'] }}</span>
                    </a>
                    </li>
                @endforeach
                {{--<li><span>习近平:要是暴力恐怖分子成为...</span></li>--}}
    ...
    <div class="item4">
        <img src="/jquery/img3/online_party_class.png" class="item2-pic"  />
        <div class="model">
            <img src="/jquery/img3/notice.png" class="item1-img" />
            <p>榜样力量</p>
            <img  class="str" src="/jquery/img3/branch_force.jpg"/>
            <ul class="index">
        ...
        <a href="TheoryStudy.html">
            <img src="/jquery/img3/theory_study.png" class="item2-pic1" />
        </a>
    </div>
    <div class="item5">
        <img src="/jquery/img3/notice.png" class="item1-img"/>
        <p style="padding-top: 8px">党校培训</p>
        @foreach($partySchool as $partySchools)
            <div class="end">
                <img src="{{ $partySchools['imgPath'] }}"/>
                <p>{{ $partySchools['title'] }}</p>
            </div>
        @endforeach
        {{--<div class="end">--}}
            {{--<img src="/jquery/img3/党校培训.jpg"/>--}}
        ...
        {{--</div>--}}
        {{--<div class="end">--}}
            {{--<img src="/jquery/img3/党校培训2.jpg"/>--}}
            {{--<p>习近平在北京大学师生座谈会上要更多这样的</p>--}}
        {{--</div>--}}
        {{--<div class="end">--}}
            {{--<img src="/jquery/img3/党校培训3.jpg"/>--}}
            {{--<p>习近平在北京大学师生座谈会上要更多这样的</p>--}}
        {{--</div>--}}
        {{--<div class="end">--}}
            {{--<img src="/jquery/img3/党校培训4.jpg"/>--}}
            {{--<p>习近平在北京大学师生座谈会上要更多这样的</p>--}}
        {{--</div>--}}
    </div>
</div>
...
<!--zhangkai=res.success;-->
<!--zhangka3=res.message-->
<!--},-->
<!--error: function(){-->
