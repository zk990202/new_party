        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form method="POST" action="{{url('manager/academy/grade-input')}}" >
                            ...
                            <button type="submit" class="btn btn-primary" onclick="if(confirm('确认要提交本页面的成绩列表吗？'))location.href='{{url('manager/academy/grade-input')}}'">提交</button>
                        </form>
                    </div>
                    <!-- /.box-body -->
                </div>
