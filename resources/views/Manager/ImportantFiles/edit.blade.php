                    ...
                    <form role="form" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block">
                                    @if($files['filePath'])
                                        已有文件：{{ $files['filePath'] }}，如不更改请勿重新添加
                                    @endif
                                    支持文件格式：
                                </p>
                            </div>
...
@section('func')
    ...
    <script>
        $(function(){
            ...
            $.ajax({
                url : '/manager/important-files/'+$('#filesId').val(),
                type: 'GET',
                dataType: 'json',
                ...
                if(file){
                    ...
                    $.ajax({
                        ...
                        if(data.success){
                            ...
                            $.ajax({
                                url: '/manager/important-files/' + $('#filesId').val() + '/edit',
                                type: 'POST',
                                data: form,
                                cache: false,
                                dataType: 'json',
                                ...
                                success: function(data){
                                    if(data.success){
                                        alert('修改成功');
                                        window.location.href = '/manager/important-files/' + $('#filesId').val() + '/edit';
                                    }
                                    else{
                                        alert(data.message);
                                    }
