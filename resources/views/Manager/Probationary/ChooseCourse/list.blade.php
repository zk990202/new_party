...
@section('func')
    ...
    <script>
        ...
        var inCourseChoose = function(id) {
            $.ajax({
                url: '/manager/probationary/choose-course/' + id + '/inCourseChoose',
                method: 'post',
                data: 'form',
                dataType : 'json',
        ...
        var exitCourseChoose = function(id) {
            $.ajax({
                url: '/manager/probationary/choose-course/' + id + '/exitCourseChoose',
                method: 'post',
                data: 'form',
                dataType : 'json',
                success: function (data) {
        ...
        var deleteEntry = function(id) {
            $.ajax({
                url: '/manager/probationary/choose-course/' + id + '/delete',
                method: 'post',
                data: 'form',
                dataType : 'json',
                success: function (data) {
