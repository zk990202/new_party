<nav class="find">
    ...
    <div class="btn">
        ...
        <ul>
            ...
            <li><a href="{{ url('applicant/certificate') }}">证书查询</a></li>
        ...
        <ul>
            ...
            <li><a href="{{ url('academy/certificate') }}">证书查询</a></li>
        </ul>
        <p><a href="#">预备党员培训</a></p>
        <ul >
            ...
            <li><a href="{{ url('probationary/grade') }}">成绩查询</a></li>
            <li><a href="{{ url('probationary/certificate') }}">证书查询</a></li>
        </ul>
    </div>
</nav>